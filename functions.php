...
'wp-login.php' === \basename($_SERVER['SCRIPT_FILENAME']) ? add_action('init', function() {
  ...
  add_filter('@chela_login_hint', function() {
   ...
   <ul><li>The username is chela.</li>
     <li>The <b>chela</b> password is the <b>last word in the title</b> of Sri Harold's front page article in the most recent <i>Mystic World</i>, <b>plus the publication year</b>. (Use all lowercase letters with no spaces. Example: ****2016)</li></ul>';
