...
'wp-login.php' === \basename($_SERVER['SCRIPT_FILENAME']) ? add_action('init', function() {
  ...
  add_filter('@chela_login_hint', function() {
    $hint = 'If you are a member of Eckankar please log in with the user name and password information below. If you are interested in becoming a member, please read about <a href=/membership>membership</a> details.
   <ul><li>The user name is chela.</li>
     <li>The <b>chela</b> password is the last word in the last sentence of the most recent Wisdom Notes.</li></ul>';
  ...
  add_filter('@access:message:denied', function() {
    ...
    $form = $in ? "<a href='$url'>Logout</a>"
      : "<h1><a href='$url'>Member</a> Login</h3>"
