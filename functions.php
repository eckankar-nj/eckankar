...
'wp-login.php' === \basename($_SERVER['SCRIPT_FILENAME']) ? add_action('init', function() {
  ...
  add_filter('@chela_login_hint', function() {
    $hint = 'The members area of the site offers additional content—tools, classes, and news—to members of Eckankar. If you are a member of Eckankar please log in with the user name and password information below. If you are interested in becoming a member, please read about <a href=/membership>membership</a> details.
   <ul><li>The username is chela.</li>
     <li>The <b>chela</b> password is the <b>last word in the title</b> of the front page article in the most recent <em>Mystic World</em>, <b>plus the publication year</b>.</li> 
