...
<div class="site-branding hgroup" itemprop="provider publisher" itemscope itemtype="http://schema.org/Organization">
  <h1 class="site-name site-title">
    <a itemprop="url name" rel="home" href="<?php echo home_url(); ?>">
      <!--[if lt IE 9]><?php bloginfo('name'); ?><![endif]-->
      <!--[if gt IE 8]><!--><img src="/static/logo/state-header-fat.png" alt="<?php bloginfo('name'); ?>"><!--<![endif]-->
    </a>
  </h1>
